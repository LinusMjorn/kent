...
class TalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post talks_url, params: { talk: { speaker: @talk.speaker, time: @talk.time, title: @talk.title } }
    end
  ...
  test "should update talk" do
    patch talk_url(@talk), params: { talk: { speaker: @talk.speaker, time: @talk.time, title: @talk.title } }
